...
void Thread::localViewCallback(const dolphin_slam::LocalViewNetworkConstPtr & msg)
{
...
void Thread::localisationErrorCallback(const dolphin_slam::ErrorConstPtr & msg)
{
    ...
    emit error_received(time,msg->experience_map_error,msg->dead_reckoning_error);
}
...
void Thread::run(){
    ...
    ros::Subscriber lv_sub = node_handle_.subscribe<dolphin_slam::LocalViewNetwork>("/local_view_cells",1000,&Thread::localViewCallback,this);
